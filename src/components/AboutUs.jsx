      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2">
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold font-display text-slate-900 mb-6 leading-tight">
          ...
          <div className="lg:w-1/2 w-full">
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-[4/3] rounded-[2.5rem] bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 overflow-hidden shadow-2xl relative">
                {/* Decorative Pattern */}
                ...
                <div className="absolute inset-0 flex items-center justify-center p-8">
                  <div className="grid grid-cols-2 gap-6 w-full">
                    {[
                      ...
                      <div key={i} className="bg-white/60 backdrop-blur-md p-6 rounded-3xl border border-white/40 shadow-sm flex flex-col items-center justify-center text-center">
                        <span className="text-3xl font-bold text-primary mb-1">{stat.value}</span>
                        <span className="text-xs uppercase tracking-wider text-slate-500 font-bold">{stat.label}</span>
                      </div>
                    ))}
                  </div>
                </div>
